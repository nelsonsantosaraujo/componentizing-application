<h1 align="center">
    Rocketseat Ignite - Componentizing application
</h1>
...
Aplicação desenvolvida com o objetivo de colocar em pratica os conceitos relacionados a componentização e refatoração aprendidos no [Ignite da Rocketseat](https://rocketseat.com.br/).
...
$ git clone https://github.com/nelsonsantosaraujo/componentizing-application.git
# Entre na pasta do repositório clonado
$ cd componentizing-application
```
